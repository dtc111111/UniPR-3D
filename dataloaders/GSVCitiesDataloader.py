...
class GSVCitiesDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        train_batch_sampler = SFrameBatchSampler(
            sampler=train_sampler,
            batch_size=self.batch_size,
            sframe_range=[self.min_support_frames, self.max_support_frames]
        )
        return DataLoader(dataset=self.train_dataset, batch_sampler=train_batch_sampler, **self.train_loader_config)
