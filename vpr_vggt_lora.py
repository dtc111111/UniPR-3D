...
class VPRModel(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.model = VGGTPR_LoRA(lora_rank=lora_rank, lora_alpha=lora_alpha, lora_dropout=lora_dropout, lora_patch_embed=lora_patch_embed,
                                 ...
                                 with_geo_features=with_geo_features, with_camera_pose=with_camera_pose, camera_pose_type=camera_pose_type)
    ...
    def training_step(self, batch, batch_idx):
        places, camera_pose, labels = batch
...
if __name__ == '__main__':
    ...
    model = VPRModel(
        ...
        vggt_aggregator_pretrain='camera_pose.pth',
